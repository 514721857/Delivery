package com.zhidao.sgr.delivery.http.webSocket;
...
public class AppResponseDispatcher implements IResponseDispatcher {
    ...
    public void onMessageResponse(Response message, ResponseDelivery delivery) {
            ...
            CommonResponse commonResponse = new CommonResponse(message.getResponseText());
            if (commonResponse.getResponseText()!=null) {
                delivery.onMessageResponse(commonResponse);
            } else {
                ErrorResponse errorResponse = new ErrorResponse();
                errorResponse.setErrorCode(12);
                errorResponse.setDescription(commonResponse.getResponseText());
